...
**Purpose**: Even though many laptops have built in support for charge limiting, many modern laptops (e.g. non-business HP laptops) lack the hardware support for it. The only way to circumvent it is by manually stopping the charging, which is often difficult to remember. Thus, a tiny reminder app can do it for you. 
